                            ...
                            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (dataSnapshot.exists()) {
                                        ...
                                        dataSnapshot.getRef().child("user_balance").setValue(500000);

                                        // berpindah activity
                                        Intent gotoReg2 = new Intent(RegisterOneActivity.this, RegisterTwoActivity.class);
                                        startActivity(gotoReg2);
                                    }
                                }
